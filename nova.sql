...
CREATE INDEX `IX_Relationship8` ON `books` (`location_id`)
;
...
ALTER TABLE `book_authors` ADD PRIMARY KEY (`id_ba`)
;
...
ALTER TABLE `books` ADD CONSTRAINT `Relationship8` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id_l`) ON DELETE RESTRICT ON UPDATE RESTRICT
;
